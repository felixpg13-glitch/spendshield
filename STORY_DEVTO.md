---
title: "My AI spent $15 on a test order, so I built an open-source payment guardrail"
published: false
description: "A real incident where a test order charged real money — and the Python + MCP library I built from it. Spend-capped agent identity, four deterministic gates, prompt-injection defense, x402-ready."
tags: [python, ai, security, mcp, opensource]
cover_image: https://raw.githubusercontent.com/felixpg13-glitch/spendshield/main/docs/favicon.svg
---
...
On Aug 9, 2026, my automation system ran a "test order." I sent `dry: true` in the body, expecting a price preview. The server only honored `?dry=1` in the URL.
